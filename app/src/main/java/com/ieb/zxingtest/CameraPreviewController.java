...
public class CameraPreviewController {
     ...
     */
    public CameraPreviewController(Activity main, TextureView view, Consumer<SurfaceTexture> updateTrigger) {
        activity = main;
        mTextureView = view;
     ...
     */
    private void lockFocusAndCapture() {
        try {
            if (mPreviewRequestBuilder == null){
                Log.e(TAG, "No preview request builder!");
                return;
            }
     ...
     * we get a response in {@link #mCaptureCallback} from {@link #lockFocusAndCapture()}.
     */
    private void runPrecaptureSequence() {
        try {
            ...
            Log.e(TAG, "Failure preparing for camera still capture");
        }
    }

    /**
     * Capture a still picture. This method should be called when we get a response in
     * {@link #mCaptureCallback} from both {@link #lockFocusAndCapture()}.
     */
    private void captureStillPicture() {
        try {
            ...
            Log.e(TAG, "Failed to trigger image capture: "+e);
        }
    }
    ...
    private static class ImageSaver implements Runnable {
        ...
        public void run() {
            ...
            buffer.get(bytes);
            try {
                Log.e(TAG, "Would have store JPEG image");
            } finally {
                mImage.close();
            }
        }
